"""
Anagrams
The goal of this exercise is to write some code to determine if two strings are anagrams of each 
other.
...
def anagram_checker(str1, str2):
    ...
    sortedS1 = sorted(str1.replace(" ", "").lower())
    sortedS2 = sorted(str2.replace(" ", "").lower())
